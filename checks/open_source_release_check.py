...
def main() -> None:
    require_text(
        ...
        [
            ...
            "https://raw.githubusercontent.com/yangKJ/think-tank-skill/master/think-tank/assets/brand/research-os-memory-runtime-image2.png",
    ...
    require_text(
        ...
        [
            "[English](README.md)",
            "https://raw.githubusercontent.com/yangKJ/think-tank-skill/master/think-tank/assets/brand/think-tank-hero-cn-image2.png",
            "https://raw.githubusercontent.com/yangKJ/think-tank-skill/master/think-tank/assets/brand/research-os-memory-runtime-image2.png",
    ...
    require_text(
        ...
        [
            ...
            "examples/usage/research-request.md",
            "examples/formats/",
            "../CHANGELOG.md",
    ...
    require_text(
        ...
        [
            ...
            "https://raw.githubusercontent.com/yangKJ/think-tank-skill/master/think-tank/assets/brand/think-tank-hero-v2-image2.png",
