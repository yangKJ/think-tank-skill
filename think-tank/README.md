...
|---|---|---|
| ![research scenario](assets/brand/research-card-image2.png) | ![council scenario](assets/brand/council-card-image2.png) | ![review scenario](assets/brand/review-card-image2.png) |
...
3.0 增加面向 agent 的 Skill Experience Layer：
...
3.0 的重点不是增加更重的 runtime，而是让 agent 更容易正确使用这个 Skill：
