...
artifact:
  path: think-tank/examples/platforms/codex/codex-local-source-artifact.md
  type: decision_memo
verified:
...
- `think-tank/examples/platforms/codex/codex-local-source-artifact.md` 已作为本地 artifact 产物写入。
