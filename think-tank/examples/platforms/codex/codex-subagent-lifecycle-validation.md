...
```yaml
owned_files:
  product-strategist: think-tank/examples/platforms/codex/subagent-lifecycle-validation/role-results/product-strategist.md
  skeptic: think-tank/examples/platforms/codex/subagent-lifecycle-validation/role-results/skeptic.md
  report-architect: think-tank/examples/platforms/codex/subagent-lifecycle-validation/role-results/report-architect.md
write_overlap: none
shared_target: no
```
...
```yaml
role_results:
  - think-tank/examples/platforms/codex/subagent-lifecycle-validation/role-results/product-strategist.md
  - think-tank/examples/platforms/codex/subagent-lifecycle-validation/role-results/skeptic.md
  - think-tank/examples/platforms/codex/subagent-lifecycle-validation/role-results/report-architect.md
