...
This example documents a media-production pattern using `research-to-video-production` as a representative peer skill. It does not claim automatic publishing, rendering, or asset ownership.
...
invoked_providers: []
not_invoked_providers:
  - research-to-video-production: available_if_user_installs_provider
boundaries:
