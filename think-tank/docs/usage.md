...
8. 如果生成了报告、样例、媒体文件或 run record，再通过 `protocol/artifact-quality-gates.md` 检查 artifact。
...
- 视频理解任务：`media-processing` 可映射到 `yt-dlp`、`openai-whisper`、`summarize`
- 视频生产任务：`media-production` 可映射到当前平台可用的来源、素材、TTS、字幕、渲染和 probe provider
