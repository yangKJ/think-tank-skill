...
| 项目 | 文件 | 状态 |
|------|------|------|
| research mode preflight | `examples/platforms/claude-code/claude-code-research-validation.md` | verified_with_format_gap |
| council mode preflight | `examples/platforms/claude-code/claude-code-council-validation.md` | verified_as_single_agent_council_preflight |
| capability discovery | `examples/platforms/claude-code/claude-code-capability-discovery.md` | skills_detected_mapping_mock |
| external source readonly | `examples/platforms/claude-code/claude-code-external-source-readonly.md` | external_source_readonly_verified_partial |
| adapter dispatch attempt | `examples/platforms/claude-code/claude-code-adapter-dispatch-attempt.md` | adapter_dispatch_not_executed_verified_partial |
| dispatch contract validation | `examples/platforms/claude-code/claude-code-dispatch-contract-validation.md` | verified_partial_with_order_gap |
| dispatch pre-invocation decision | `examples/platforms/claude-code/claude-code-dispatch-pre-invocation-validation.md` | verified_partial_pre_invocation_decision |
| final low-flow validation | `examples/platforms/claude-code/claude-code-final-validation.md` | verified_partial_with_success_pre_invocation_and_failure_degradation |
...
sample: think-tank/examples/runtime/claude-runtime-sample.json
failure_sample: think-tank/examples/runtime/claude-runtime-failure-sample.json
...
```text
think-tank/examples/platforms/claude-code/claude-code-final-validation.md
```
