...
This directory stores prompts used to generate public README visuals.

Prompt files are part of the source record. They let maintainers regenerate images without committing raw design work files.
